...
describe('Part 2 — Prompt caching', () => {
  ...
  ifOpenAI(
    'OpenAI: second request with same cache key returns cached tokens',
    async () => {
  ...
  ifAnthropic(
    'Anthropic: first request writes cache, second reads it back',
    async () => {
  ...
  ifGemini(
    'Gemini: create cache → use it in completion → cached tokens confirmed',
    async () => {
  ...
  ifGemini(
    'Gemini: googleCaches CRUD — create, get, update, list, delete',
    async () => {
