...
liveDescribe('live-real package exports', () => {
    ...
    it('imports built package exports from a clean ESM, CJS, and TS consumer', () => {
        ...
        writeFileSync(join(temp, 'esm.mjs'), `${subpaths
...
`);
        ...
        writeFileSync(join(temp, 'cjs.cjs'), `${subpaths
...
`);
        ...
        writeFileSync(join(temp, 'consumer.ts'), `import { LLMClient, InMemorySessionStore, type ConversationSnapshot } from 'unified-llm-client';
