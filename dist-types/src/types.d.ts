...
export type TranscriptionHostnameResolver = (hostname: string) => Promise<string[]> | string[];
...
export type TranscriptionResponseFormat = 'diarized_json' | 'json' | 'srt' | 'text' | 'verbose_json' | 'vtt';
...
export type SpeechCostUnit = 'audio_input_token' | 'audio_output_token' | 'audio_second' | 'character' | 'request' | 'text_input_token' | 'text_output_token';
